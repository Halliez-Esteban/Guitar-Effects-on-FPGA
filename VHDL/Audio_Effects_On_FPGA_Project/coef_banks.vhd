...
-- 
-- This file describes two 19 coefficients sets on 16 bits, to be used by the "FIR_filter_37_tap" component.
-- The coefficients selection is achieved with the "select_coef_bank" input.
-- ================================================================================================
...
LIBRARY ieee;									-- This part must be written twice
USE ieee.std_logic_1164.ALL;				-- If not, STD_LOGIC and STD_LOGIC_VECTOR
USE ieee. Std_logic_arith.all;			-- can't be used
USE ieee.std_logic_signed.all;			-- even if "LIBRARY ieee; etc." are already present on top of this file.
...
begin
	...
	if select_coef_bank = 0 then							-- low-pass filter
		...
		/*
	elsif select_coef_bank = 2 then							-- high pass filter
